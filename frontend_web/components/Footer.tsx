    ...
    <footer className='bg-emerald-800 text-white'>
      <div className='mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-7xl'>
        <div className='md:grid-cols-2 lg:grid-cols-4 grid grid-cols-1 gap-8'>
          <div>
            <p className='text-xl font-bold mb-4'>Course Clash</p>
            <p className='text-emerald-200 mb-4'>
              Transforma tu experiencia de aprendizaje en una aventura
          ...
          <div>
            <p className='text-lg font-semibold mb-4'>Plataforma</p>
        ...
        <div className='mt-12 pt-8 border-t border-emerald-700'>
          <p className='text-emerald-200 text-center'>
            &copy; {new Date().getFullYear()} Course Clash. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
