                ...
                "QuizScreen.useEffect.handleMessage": (event)=>{
                    try {
                        ...
                        if (typeof event.data === 'string' && !event.data.startsWith('{')) {
                            ...
                            if (event.data === '¡Oponente conectado! El duelo comenzará pronto.') {
                                setIsWaiting(true);
                            }
                            return;
                        }
...
_s(QuizScreen, "B/gdqrk1xgKOMjX2j4aZOyNo1AU=");
_c = QuizScreen;
var _c;
...
function DuelosContent() {
    ...
    const { searchUserByEmail, foundUser, searchLoading, searchError, requestDuel, requestLoading, requestError, acceptDuel, acceptLoading, acceptError, error: apolloError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$duel$2d$hooks$2d$apollo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDuels"])();
    ...
    const [notificationWs, setNotificationWs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DuelosContent.useEffect": ()=>{
            const combinedError = apolloError || searchError || requestError || acceptError;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DuelosContent.useEffect": ()=>{
            ...
            const gracePeriodTimer = setTimeout({
                "DuelosContent.useEffect.gracePeriodTimer": ()=>{
                    errorGracePeriod = false;
                }
            }["DuelosContent.useEffect.gracePeriodTimer"], 5000);
            if (user?.id && !notificationWs) {
                console.log(`Attempting to connect to notifications WebSocket for user ${user.id}...`);
                const connectWebSocket = {
                    "DuelosContent.useEffect.connectWebSocket": ()=>{
                        // No intentar conectar si el componente ya no está montado
                        if (!isComponentMounted) return;
                        connectionAttempts++;
                        const wsUrl = `ws://localhost:8002/ws/notifications/${user.id}`;
                        console.log(`Connecting to WebSocket URL: ${wsUrl} (attempt ${connectionAttempts})`);
                        try {
                            ...
                            localWs.onopen = ({
                                "DuelosContent.useEffect.connectWebSocket": ()=>{
                                    ...
                                    console.log("Notification WebSocket connection established successfully");
                                    setError(null);
                            ...
                            localWs.onmessage = ({
                                "DuelosContent.useEffect.connectWebSocket": (event)=>{
                                    if (!isComponentMounted) return;
                                    try {
                                        ...
                                        if (data.type === "duel_request") {
                                            ...
                                            setPendingChallenges({
                                                "DuelosContent.useEffect.connectWebSocket": (prev)=>[
                                                        ...prev,
                                                        {
                                                            duelId: data.duelId,
                            ...
                            localWs.onerror = ({
                                "DuelosContent.useEffect.connectWebSocket": (error)=>{
                                    if (!isComponentMounted) return;
                            ...
                            localWs.onclose = ({
                                "DuelosContent.useEffect.connectWebSocket": (event)=>{
                                    if (!isComponentMounted) return;
                                    console.log(`Notification WebSocket connection closed. Code: ${event.code}, Reason: ${event.reason}`);
                                    ...
                                    if (event.code !== 1000 && connectionAttempts < 5 && isComponentMounted) {
                                        ...
                                        }["DuelosContent.useEffect.connectWebSocket"], 5000); // Aumentado a 5 segundos para ser menos agresivo
        ...
        user?.id
    ]); // Solo depender de user?.id, no de notificationWs
    ...
    const handleRequestDuel = async ()=>{
        ...
        if (user && !user.id) {
            console.log("User exists but ID is missing. Full user object:", JSON.stringify(user));
            ...
            if (alternativeId && foundUser) {
                ...
                try {
                    ...
                    if (response.duelId) {
                        ...
                        const ws = new WebSocket(`ws://localhost:8002/ws/duels/${response.duelId}/${alternativeId}`);
                        ws.onopen = ()=>{
                            setError(null);
                            setShowQuiz(true);
                        };
            ...
            setError("Tu sesión existe pero falta el ID de usuario. Intenta cerrar sesión y volver a iniciar.");
            return;
        }
        // Original check
        if (!user?.id) {
        ...
        try {
            ...
            if (response.duelId && user?.id) {
                ...
                const ws = new WebSocket(`ws://localhost:8002/ws/duels/${response.duelId}/${user.id}`);
                ws.onopen = ()=>{
                    setError(null);
                    setShowQuiz(true);
                };
    ...
    const handleChallengeAccept = (duelId)=>{
    ...
    const handleChallengeReject = (duelId)=>{
        // Remove from pending challenges
        setPendingChallenges((prev)=>prev.filter((challenge)=>challenge.duelId !== duelId));
    };
    const handleAcceptDuel = async (duelId)=>{
        ...
        try {
            ...
            if (duelId && user?.id) {
                ...
                // Crear nueva conexión WebSocket
                const ws = new WebSocket(`ws://localhost:8002/ws/duels/${duelId}/${user.id}`);
                ws.onopen = ()=>{
                    setError(null);
                    setShowQuiz(true);
                };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: !showQuiz ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mx-auto px-4 py-8 container",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-3xl font-bold text-emerald-700 mb-6 text-center flex items-center justify-center gap-2",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$TrophyIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrophyIcon$3e$__["TrophyIcon"], {
                            className: "w-8 h-8"
                        }, void 0, false, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "lg:w-1/2 bg-white rounded-xl shadow-lg border border-emerald-100 p-6 flex flex-col justify-center",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                pendingChallenges.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-3",
                                            children: pendingChallenges.map((challenge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DuelosContent, "vaD1KIjDdRX0Eok1W7j1IureeIs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2d$apollo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthApollo"],
...
//# sourceMappingURL=_4d9a1957._.js.map