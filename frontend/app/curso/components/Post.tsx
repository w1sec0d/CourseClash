    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      <div className="p-4">
        <div className="justify-between items-start mb-4 flex">
          ...
          <div className="items-center flex">
            {badge && (
              <span className={`bg-${badge.color}-100 text-${badge.color}-700 text-xs px-2 py-1 rounded-full items-center mr-2 flex`}>
                {badge.text}
              </span>
            )}
            <button
        ...
        <div className="items-center justify-between text-sm flex">
          ...
          {reward && (
            <div className="items-center flex space-x-1">
              {reward.icon}
              <span className="text-xs text-amber-500 font-medium">{reward.text}</span>
            </div>
          )}
        </div>
      </div>
